...
class Blueprint(BaseModel):
    ...
    core_concept: str
    deep_dive_dimensions: list[str] = Field(
        description=(
            "Subject-appropriate dimension labels for the deep dive compare/contrast section; "
            "generated by the blueprint node based on subject and competency."
        )
    )

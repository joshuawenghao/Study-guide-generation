"""Intro section node for the study guide workflow."""
...
async def generate_intro(
    ...
    return await generate_section(
        request=request,
        blueprint=blueprint,
        prompt_builder=build_intro_prompt,
        context_label="intro",
    )


intro_node = cast(Callable[[StudyGuideRequest, Blueprint], Any], node(generate_intro))

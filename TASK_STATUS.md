...
- The assessment-question grounding validator now also accepts question-aligned location and author-purpose hints when they still anchor the learner to the passage topic, reducing false failures on reasonable English hints that point students to a paragraph, a defined term, or an author-purpose decision without quoting the answer text verbatim.
- The assessment-question grounding validator now also accepts question-aligned guidance hints that still anchor to the current passage content, reducing false failures on reasonable prompts such as asking students to look for the correct color-coded bin or another question-specific clue even when the hint is not a near-verbatim passage fragment.
- The assessment-question grounding validator now also checks the full assessment-passage paragraphs alongside `evidence_clues`, reducing false failures on reasonable nursing hints that point students to the final paragraph or a procedural step even when the clue list is narrower than the actual passage evidence.
